...
const {addComplaint,getAllComplaint,getComplaintById,getComplaintByTechId,getComplaintByUserId,editIssueImage ,editComplaint,deleteComplaint,updateComplaint}=require("../controllers/complaintController")
